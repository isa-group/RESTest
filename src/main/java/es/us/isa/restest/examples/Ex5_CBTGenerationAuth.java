...
public class Ex5_CBTGenerationAuth {
    ...
    public static String propertyFilePath="src/main/resources/Examples/Ex5_CBTGenerationAuth/youtube_getVideos.properties"; 		// Path to user properties file with configuration options
