...
public class SpecificationVisitor {
    ...
    public static Operation findOperation(String operationId, OpenAPISpecification apiSpec) {
    ...
    /**
     * Returns the parameters that are required for the operation and are not
     * path parameters.
     *
     * @param operation Operation in the specification
     * @return
    ...
    /**
     * Returns the parameters of an operation whose values can be changed for
     * invalid values. These include the following:
     * <ol>
