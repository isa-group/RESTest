...
public class BoundaryNumberConfigurator {
    ...
    public List<? extends Number> returnValues() {
        ...
        if (type.equals(DataType.INTEGER) || type.equals(DataType.INT32) || type.equals(DataType.INT64) || type.equals(DataType.LONG)) {
    ...
    // Necessary function for when datatype is integer-like. Otherwise, string values written in test cases
