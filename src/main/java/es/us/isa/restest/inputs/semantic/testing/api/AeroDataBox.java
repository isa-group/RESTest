...
public class AeroDataBox {
    ...
    // codeTo
    public static Response aeroDataBox_FlightTimeToAnotherAirportByIataIcao_codeTo_regex(String semanticInput, String apiKey, String host) throws IOException {
        String url = baseUri + "/airports/iata/LHR/distance-time/" + semanticInput;
