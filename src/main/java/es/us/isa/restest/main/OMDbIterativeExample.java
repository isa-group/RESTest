...
// *
// */
//public class OMDbIterativeExample {
//
//    private static int numTestCases = 20;												// Number of test cases per operation
//    private static String OAISpecPath = "src/test/resources/OMDb/swagger.yaml";		// Path to OAS specification file
//    private static String confPath = "src/test/resources/OMDb/testConf.yaml";		// Path to test configuration file
//    private static String apikeysPath = "OMDb/apikeys.json";							// Path where API keys are stored
//    private static String targetDirJava = "src/generation/java/omdb";				// Directory where tests will be generated.
...
//    private static String packageName = "omdb";										// Package name.
//    private static String APIName = "omdb";											// API name
//    private static String testClassName = "OMDbTest";								// Name prefix of the class to be generated
//    private static OpenAPISpecification spec;
//    private static int totalNumTestCases = 20;											// Total number of test cases to be generated
