...
// *
// */
//public class YouTubeSearchIterativeExample {
//
//	private static int numTestCases = 4;												// Number of test cases per operation
//	private static String OAISpecPath = "src/test/resources/YouTube/swagger.yaml";		// Path to OAS specification file
//	private static String confPath = "src/test/resources/YouTube/testConf.yaml";		// Path to test configuration file
//	private static String apikeysPath = "YouTube/apikeys.json";							// Number of test cases per operation
//	private static String targetDirJava = "src/generation/java/youtube";				// Directory where tests will be generated.
...
//	private static String packageName = "youtube";										// Package name.
//	private static String APIName = "youtube";											// API name
//	private static String testClassName = "YouTubeTest";								// Name prefix of the class to be generated
//	private static OpenAPISpecification spec;
//	private static int totalNumTestCases = -1;											// Total number of test cases to be generated
//	private static int timeDelay = 3600;													// Optional time delay between iterations (in seconds)
//
