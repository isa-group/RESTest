...
public class TestGenerationAndExecution {
	...
	private static String propertiesFilePath = "src/---/resources/API_PILOT/GitHub/createOrganizationRepository/user03/github_createAnOrganizationRepository.properties";
