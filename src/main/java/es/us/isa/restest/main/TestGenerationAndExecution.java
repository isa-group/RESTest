...
public class TestGenerationAndExecution {
	...
	private static String propertiesFilePath = "src/test/resources/SemanticAPIs/CommercialAPIs/Spotify/browseCategories/spotifySemantic_browseCategories.properties";
