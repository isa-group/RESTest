...
public class NumberToInvalidTest {
    ...
    public void mutationAppliedTest() {
        ...
        OpenAPIParameter paramToMutate = new OpenAPIParameter(spec.getSpecification().getPaths().get("/gallery").getPut().getParameters().stream().filter(p -> p.getName().equals("rarity")).findFirst().get());
