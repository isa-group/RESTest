...
public class EnumToInvalidTest {
    ...
    public void mutationAppliedTest() {
        ...
        OpenAPIParameter paramToMutate = new OpenAPIParameter(spec.getSpecification().getPaths().get("/comments").getGet().getParameters().stream().filter(p -> p.getName().equals("type")).findFirst().get());
