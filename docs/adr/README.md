...
| [0014](0014-response-conformance.md) | A reply is judged against the specification document itself | Accepted, amended at M1.7c |
| [0015](0015-command-line-contract.md) | One command, a budget spent in full, and what an exit code means | Accepted, amended at M1.7 and M1.7c |
